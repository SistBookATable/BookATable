...
public class ReservationView {
	...
	public int getUserReservationNum() {
	...
	public String getUserReservationDate() {
	...
	public String getUserReservationTime() {
	...
	public String getUserReservationMenu() {
	...
	public int getReservationNum() {
	   ...
	   public String showReservationResult(int num, String date, String time, String menu) {
	      String tmp="";
